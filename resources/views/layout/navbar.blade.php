        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <div class="input-group">
                ...
                {{-- Added id="navbarSearch" here --}}
                <input type="text" id="navbarSearch" class="form-control" placeholder="Type here...">
            </div>
          </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Debug 2: Check if we found the input and rows
        if (searchInput) {
            console.log("✅ Found Search Input");
        } else {
            console.error("❌ Could NOT find input with id='navbarSearch'. Check your Navbar HTML!");
        }
        ...
        if (searchInput) {
            searchInput.addEventListener('keyup', function(e) {
                ...
                console.log("Typing:", searchTerm); // Debug 3: See what you type
