...
@section('content')
    ...
    {{-- 2. MIDDLE SECTION (ROCKET & IMAGE CARD) --}}
    <div class="row mt-4">
    ...
    {{-- 3. CHARTS SECTION (THE PART THAT WAS MISSING GRAPHICS) --}}
    <div class="row mt-4">
            ...
            <div class="card z-index-2">
                <div class="card-body p-3">
                    <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                        <div class="chart">
                            {{-- This Canvas needs the JS below to render --}}
        ...
        <div class="col-lg-7">
            <div class="card z-index-2">
                ...
                <div class="card-body p-3">
                    <div class="chart">
                        {{-- This Canvas also needs JS to render --}}
...
{{-- 5. CRITICAL FIX: PUSH THE CHART JS CODE HERE --}}
@push('scripts')
    <script>
